...
const styles = StyleSheet.create({
  ...
  grid: { flex: 1 },
  placeholder: { borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.06)', margin: 4 },
  ...
  progressLineBg: { height: 6, width: '100%', backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 6, overflow: 'hidden' },
  progressLineFill: { height: '100%', backgroundColor: '#fff' },
  progressUploadingText: { color: '#E6EAF2', fontSize: 12, textAlign: 'center' },
  hint: { color: '#FDE68A', fontSize: 12, marginBottom: 8 },
});
